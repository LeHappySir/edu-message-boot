...
import com.lagou.edu.course.client.remote.LessonRemoteService;
...
public class MessageServiceImpl extends ServiceImpl<MessageMapper, Message> implements IMessageService {
	...
	*/
	...
	public DataGrid<MessageDTO> getMessageByUserId(MessageQueryDTO messageQueryDTO) {
        ...
        dataGrid.setRows(CoverUtil.coverList(pageDate.getRecords(), MessageDTO.class));
	...
	*/
	@Override
	public void sendMessage(com.lagou.edu.message.client.dto.Message message) {
		if(null == message) {
			return;
		}
